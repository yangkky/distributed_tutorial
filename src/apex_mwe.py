...
def main():
    ...
    parser.add_argument('-lr', '--lr', default=0.001, type=float, metavar='N',
                        help='learning rate')
...
def main_worker(gpu, args):
    ...
    model = DPP(model.cuda(gpu))
    # model = nn.parallel.DistributedDataParallel(model.cuda(gpu), device_ids=[gpu])
